...
const MovieForm = ({isModalOpen,setIsModalOpen,selectedMovie,setSelectedMovie,formType,getData}) => {
    console.log("selected movie in movie form", selectedMovie);
    ...
    const onFinish = async (values) =>{
        try{
            ...
            //  console.log("movie id in movie form", selectedMovie);
            let response =null;
            if(formType === "add"){
                response = await addMovie(values);
            }else{
                // console.log("movie id in movie form", selectedMovie._id);
